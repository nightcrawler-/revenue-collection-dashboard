!function (e, n) {
    ...
    function r(r, a, i) {
        ...
        i.currentIndex = l, s.each(function (a) {
            var i = e(this), s = o.eq(a), l = s.data("mode"), d = null == l ? Y.html : g(Y, /^\s*$/.test(l) || isNaN(l) ? l : parseInt(l, 0)), u = d === Y.html || s.data("url") === n ? "" : s.data("url"), c = d !== Y.html && "1" === s.data("loaded"), f = e.extend({}, ne, {
                title: i.html(),
    ...
    function _(n, t, r, a, i) {
        (0 > a || a > r.stepCount) && $(J), i = e.extend({}, ne, i), A(n, a, i), r.currentIndex !== r.stepCount && r.currentIndex >= a && (r.currentIndex++, j(n, t, r)), r.stepCount++;
    ...
    function U(n, t, r, a, i, s) {
        var o = n.find(".content > .body"), l = g(ee, t.transitionEffect), d = t.transitionEffectSpeed, u = o.eq(a), c = o.eq(i);
        switch (l) {
            case ee.fade:
            case ee.slide:
                var f = l === ee.fade ? "fadeOut" : "slideUp", h = l === ee.fade ? "fadeIn" : "slideDown";
    ...
    }, e.fn.steps.setStep = function (e, n) {
    ...
    var Y = e.fn.steps.contentMode = {html: 0, iframe: 1, async: 2}, Z = e.fn.steps.stepsOrientation = {
        ...
        onFinished: function (e, n) {
        },
        onContentLoaded: function (e, n) {
        },
        onInit: function (e, n) {
        },
        labels: {
